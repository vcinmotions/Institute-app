...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke border-gray-200 bg-white dark:border-gray-800 dark:bg-black">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-28">
          {/* <!-- Footer Top --> */}
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5 dark:text-gray-200">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>

                <p className="mb-1.5 dark:text-gray-400 text-sectiontitle uppercase tracking-[5px]">
                  contact
                </p>
                <a
                  href="#"
                  className="text-itemtitle font-medium text-black dark:text-gray-200"
                >
                  hello@solid.com
                </a>
              </motion.div>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  <h4 className="mb-9 text-itemtitle2 font-medium text-black dark:text-gray-400">
                    Quick Links
                  </h4>
                  ...
                  <ul>
                    <li>
                      <a
                        href="#"
                        className="mb-3 inline-block hover:text-blue-400 dark:hover:text-blue-400 dark:text-gray-200"
                      >
                        Home
                      </a>
                    </li>
                ...
                >
                  ...
                  <p className="mb-4 w-[90%] dark:text-gray-200">
                  ...
                  <form action="#">
                    <div className="relative">
                      <input
                        ...
                        className="rounded-full border border-stroke px-6 py-2.5 shadow-solid-2 focus:border-primary focus:outline-hidden dark:border-gray-400 text-gray-900 placeholder:text-gray-400 dark:placeholder:text-gray-400 dark:text-white dark:bg-black dark:shadow-none dark:focus:border-gray-400"
                      />
          ...
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke dark:border-gray-700 py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
            ...
            >
              <ul className="flex items-center gap-8">
                <li>
                  <a href="#" className="hover:text-blue-400 dark:text-gray-200">
                    English
                  </a>
                </li>
                <li>
