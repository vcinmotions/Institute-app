...
const FAQItem = ({ faqData }: { faqData: FaqData }) => {
  ...
  return (
    <>
      <div className="flex flex-col border-b dark:border-gray-400 border-stroke last-of-type:border-none dark:border-strokedark">
        <button
          onClick={() => {
            handleFaqToggle(id);
          }}
        ...
        <p
          className={`border-t dark:border-gray-400 dark:text-white border-stroke px-6 py-5 dark:border-strokedark lg:px-9 lg:py-7.5 ${
