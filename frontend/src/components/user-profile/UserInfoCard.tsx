...
export default function UserInfoCard() {
  ...
  const editMaster = useEditMaster();
  ...
  const handleSave = () => {
    ...
    if (user.role === "MASTER_ADMIN") {
      editMaster.mutate(payload, { onSuccess: () => closeModal() });
    } else {
      editClient.mutate(payload, { onSuccess: () => closeModal() });
    }
  };
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                {user?.role === "MASTER_ADMIN" ? "Email address" : "Username"}
              </p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                {user?.email}
              </p>
        ...
        <ShowForRoles allowedRoles={["MASTER_ADMIN"]}>
          <button
            onClick={openModal}
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input
                      type="text"
                      value={form.contact || form.contact}
