// backend/utils/templates/login-notification.ts

export function generateLoginEmailTemplate(name: string, loginTime: string, ipAddress?: string) {
  return `
  <!doctype html>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                Hello ${name}!<br></br>
                                                Thank you for signing in. We're really happy to have you! Click the link below to login to your account:
                                            </div>
