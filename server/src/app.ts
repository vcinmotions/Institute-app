...
import reportRoute from "../src/routes/reports.routes";
...
app.use(cors({ origin: 'http://localhost:3000', credentials: true, exposedHeaders: ["Content-Disposition"] })); // Or whatever port your React app runs on
